...
from config import volume_widget
from config import color_picker_widget
from config import brightness_widget
from config import multi_monitor_widget
from config import sticky_manager
...
webbrowser = "flatpak run com.google.Chrome"
